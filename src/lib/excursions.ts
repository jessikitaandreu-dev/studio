...
export const excursions: Excursion[] = [
  ...
  },
  {
    ...
    itinerary: ['Vuelos y alojamiento en hotel céntrico.', 'Visitas guiadas a los principales museos y monumentos.', 'Eventos sociales exclusivos para el grupo.', 'Tiempo libre para explorar a tu aire.', 'Guía acompañante durante todo el viaje.'],
    departureLocation: 'Aeropuerto Principal (variable)',
    arrivalLocation: 'Aeropuerto Principal (variable)',
