...
export const excursions: Excursion[] = [
  ...
  {
    slug: 'ruta-gastronomica-singles',
    title: 'Ruta Gastronómica para Singles',
    category: 'singles',
    categoryLabel: 'Para Solteros',
    isFeatured: true,
    imageId: 'gastronomic-route-singles',
    description: 'Un recorrido por los mejores bares de tapas de la ciudad. Una oportunidad perfecta para degustar la gastronomía local y conocer gente nueva.',
    itinerary: ['Encuentro en la plaza principal.', 'Visita a 4 bares de tapas seleccionados.', 'Degustación de una tapa y una bebida en cada bar.', 'Guía local experto en gastronomía.', 'Finalización en un local con música para seguir la noche.'],
    departureLocation: 'Plaza Mayor',
    arrivalLocation: 'Zona centro (local por confirmar)',
    duration: '3-4 Horas',
  },
  {
